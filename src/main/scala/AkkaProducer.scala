...
//https://www.programcreek.com/scala/akka.kafka.scaladsl.Producer
object AkkaProducer extends App {
  ...
  val runnableGraph = RunnableGraph.fromGraph(GraphDSL.create() { implicit builder =>
    ...
    val mapToProducerRecord =
      Flow[String].map(elem => new ProducerRecord[Array[Byte], String](kafkaTopic, elem))
